...
export class EmailServiceUtils {
  ...
  private async getSMTPSettings() {
    ...
    console.log(settings, ' here call ');

    return {
      smtpHost: this.getSettingValue(settings, 'smtpHost'),
      smtpPort: parseInt(this.getSettingValue(settings, 'smtpPort') || '587'),
      smtpSecure: this.getSettingValue(settings, 'smtpSecure') === 'true',
      smtpUsername: this.getSettingValue(settings, 'smtpUsername'),
      smtpPassword: this.getSettingValue(settings, 'smtpPassword'),
      smtpFromEmail: this.getSettingValue(settings, 'smtpFromEmail'),
      smtpFromName: this.getSettingValue(settings, 'smtpFromName'),
      smtpEnabled: this.getSettingValue(settings, 'smtpEnabled') === 'true',
    };
  }
